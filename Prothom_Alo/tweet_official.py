# Practice caution when using tweet.py with Twikit library
# as it may cause the suspension of your X account - Victim

# Limits to 50 posts per day @ free tier. Not enough for the project.
